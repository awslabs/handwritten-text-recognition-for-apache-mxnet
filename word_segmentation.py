...
if __name__ == "__main__":
    ...
    train_ds = IAMDataset("form_bb", output_data="bb", output_parse_method="word", train=True)
    print("Number of training samples: {}".format(len(train_ds)))

    test_ds = IAMDataset("form_bb", output_data="bb", output_parse_method="word", train=False)
